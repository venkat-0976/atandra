import { CheckCircle, Zap, Shield, Wrench, Mail, Star, Download, Info, ShieldCheckIcon, GaugeIcon, ZapIcon } from 'lucide-react';
...
const ServoStabilizers3Phase = () => {
  ...
  const jsonLd = {
    ...
    "description": "Three phase servo stabilizers with independent phase control, LCD display and high overload capacity for industrial machinery.",
    "brand": {
      "@type": "Brand",
      "name": "KRYKARD"
    },
    "model": "Three Phase Servo Stabilizer",
    "image": "https://atandra.in/Servo_stabilizers/SS_28_-1-removebg-preview.png",
    "offers": {
      "@type": "Offer",
  ...
  return (
    <>
      <SeoHead
        title="Three Phase Servo Stabilizers for Industrial Equipment"
        description="Three phase servo stabilizers with independent phase control, LCD display and high overload capacity for industrial machinery."
        keywords="three phase servo stabilizer, 3 phase stabilizer, industrial stabilizer, heavy machinery stabilizer, industrial voltage regulator, air cooled stabilizer, oil cooled stabilizer, manufacturing stabilizer, industrial voltage correction"
        canonical="https://atandra.in/protect/servo-stabilizers/product/three-phase-servo-stabilizer"
        ogImage="/Servo_stabilizers/SS_28_-1-removebg-preview.png"
        jsonLd={jsonLd}
        preloadImage="/Servo_stabilizers/SS_28_-1-removebg-preview.png"
      />
      <PageLayout
        hideHero={true}
        ...
        <div className="bg-white font-sans min-h-screen font-open-sans">
          ...
          <div className="w-full flex justify-center items-center mt-16 mb-24">
            <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white rounded-2xl shadow-lg px-10 py-10 max-w-2xl w-full text-center">
              <h2 className="text-2xl sm:text-3xl font-bold mb-3">Ready for Industrial Power Protection?</h2>
