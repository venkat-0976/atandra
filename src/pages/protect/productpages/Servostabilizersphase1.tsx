import { CheckCircle, Zap, Shield, Wrench, Mail, Star, Download, Settings, ShieldCheckIcon, GaugeIcon, ZapIcon } from 'lucide-react';
...
const ServoStabilizersPhase1 = () => {
  ...
  const jsonLd = {
    ...
    "description": "Single phase servo stabilizers with fast response, digital control and wide voltage range for safe operation of sensitive electronics.",
    "brand": {
      "@type": "Brand",
      "name": "KRYKARD"
    },
    "model": "Single Phase Servo Stabilizer",
    "image": "https://atandra.in/Servo_stabilizers/SS_12_-_1-removebg-preview.png",
    "offers": {
      "@type": "Offer",
  ...
  return (
    <>
      <SeoHead
        title="Single Phase Servo Stabilizers for Homes & Offices"
        description="Single phase servo stabilizers with fast response, digital control and wide voltage range for safe operation of sensitive electronics."
        keywords="single phase servo stabilizer, 1 phase stabilizer, home stabilizer, residential stabilizer, small business stabilizer, digital stabilizer, voltage regulator for home, domestic stabilizer, household stabilizer"
        canonical="https://atandra.in/protect/servo-stabilizers/product/single-phase-servo-stabilizer"
        ogImage="/Servo_stabilizers/SS_12_-_1-removebg-preview.png"
        jsonLd={jsonLd}
        preloadImage="/Servo_stabilizers/SS_12_-_1-removebg-preview.png"
      />
      <PageLayout
        hideHero={true}
        hideBreadcrumbs={true}
      >
        {/* Removed EnhancedPageTitle to eliminate the hero section */}
        ...
        <div className="bg-white font-sans min-h-screen font-open-sans">
          ...
          <div className="w-full flex justify-center items-center mt-16 mb-24">
            <div className="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 text-white rounded-2xl shadow-lg px-10 py-10 max-w-2xl w-full text-center">
              <h2 className="text-2xl sm:text-3xl font-bold mb-3">Ready for Reliable Power Protection?</h2>
